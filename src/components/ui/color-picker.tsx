    ...
    >
      <div
        ...
        style={{
          left: `${positionX * 100}%`,
          top: `${positionY * 100}%`,
          boxShadow: "0 1px rgba(0,0,0,0.5)",
        }}
      />
    </div>
  )
  ...
  return (
    <div className='relative'>
      <Input
        ...
        {...props}
        className={cn(
          "h-8 w-13 rounded-l-none bg-slate-100 px-2 text-xs shadow-none dark:bg-slate-800",
          className
        )}
      />
      <span className='-translate-y-1/2 absolute top-1/2 right-2 text-slate-500 text-xs dark:text-slate-400'>
        %
      </span>
    </div>
  )
...
export const ColorPickerFormat = ({ className, ...props }: ColorPickerFormatProps) => {
  ...
  if (mode === "hex") {
    ...
    return (
      ...
      >
        <Input
          className='h-8 rounded-r-none bg-slate-100 px-2 text-xs shadow-none dark:bg-slate-800'
          readOnly
          type='text'
          value={hex}
        />
    ...
    return (
      ...
      >
        {rgb.map((value, index) => (
          <Input
            className={cn(
              "h-8 rounded-r-none bg-slate-100 px-2 text-xs shadow-none dark:bg-slate-800",
  ...
  if (mode === "css") {
    ...
    return (
      <div className={cn("w-full rounded-md shadow-sm", className)} {...props}>
        <Input
          className='h-8 w-full bg-slate-100 px-2 text-xs shadow-none dark:bg-slate-800'
          readOnly
          type='text'
